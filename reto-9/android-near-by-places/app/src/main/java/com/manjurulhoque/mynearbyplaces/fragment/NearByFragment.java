...
public class NearByFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mispinner = (Spinner)view.findViewById(R.id.spinner3);
    ...
    private String buildUrl(double latitude, double longitude, String API_KEY) {
        ...
        int kilometros = mispinner.getSelectedItemPosition();

        urlString.append("&location=");
        urlString.append(Double.toString(latitude));
        urlString.append(",");
        urlString.append(Double.toString(longitude));
        urlString.append("&radius="+kilometros+"000"); // places between 5 kilometer
